Feature: Gerenciar Automovel

Scenario Outline: Eu, como Usuário Autenticado, quero cadastrar um(a) Automovel
...
Scenario Outline: Eu, como Usuário Autenticado, quero atualizar a Automovel
...
Scenario Outline: Eu, como Usuário Autenticado, quero buscar a Automovel
