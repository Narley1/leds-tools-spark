Feature: Gerenciar Instrutor

Scenario Outline: Eu, como Usuário Autenticado, quero cadastrar um(a) Instrutor
...
Scenario Outline: Eu, como Usuário Autenticado, quero atualizar a Instrutor
...
Scenario Outline: Eu, como Usuário Autenticado, quero buscar a Instrutor
