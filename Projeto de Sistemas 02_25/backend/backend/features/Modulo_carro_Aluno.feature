...
Scenario Outline: Eu, como Usuário Autenticado, quero cadastrar um(a) Aluno
...
Scenario Outline: Eu, como Usuário Autenticado, quero atualizar a Aluno
...
Scenario Outline: Eu, como Usuário Autenticado, quero buscar a Aluno
