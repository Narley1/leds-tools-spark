Feature: Gerenciar Aula

Scenario Outline: Eu, como Usuário Autenticado, quero cadastrar um(a) Aula
...
Scenario Outline: Eu, como Usuário Autenticado, quero atualizar a Aula
...
Scenario Outline: Eu, como Usuário Autenticado, quero buscar a Aula
